                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="@lang('banks.title')" >
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="minimum_payment" class="form-control" value="{{ old('minimum_payment') }}" placeholder="@lang('banks.minimum_payment')" step=".01" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="limit_payment" class="form-control" value="{{ old('limit_payment') }}" placeholder="@lang('banks.limit_payment')" step="0.01" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fee_percentage" class="form-control" value="{{ old('fee_percentage') }}" placeholder="@lang('banks.fee_percentage')" step="0.01" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" class="form-control" value="{{ old('address') }}" placeholder="@lang('banks.address')" >
